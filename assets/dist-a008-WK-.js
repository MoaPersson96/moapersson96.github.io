...
`).find(e=>!e.trim().startsWith(`#`)&&e.trim()!==``)}async function so(e){try{let t=(await fetch(e,{method:`HEAD`})).headers.get(`Content-Type`);return Ka.some(e=>t===e)}catch(e){return console.error(`Error while trying to get the Content-Type of the manifest`,e),!1}}async function co(e){try{let t=await(await fetch(e)).text(),n=t,r=ao(t);if(r.length>0){let t=new URL(r[0],e).toString();n=await(await fetch(t)).text()}return io(oo(n))}catch(e){console.error(`Error while trying to parse the manifest playlist`,e);return}}var lo=new qa,uo=new WeakSet,fo;Ja(()=>{if(!globalThis.chrome?.cast?.isAvailable){console.debug(`chrome.cast.isAvailable`,globalThis.chrome?.cast?.isAvailable);return}fo||(fo=cast.framework,Za().addEventListener(fo.CastContextEventType.CAST_STATE_CHANGED,e=>{lo.forEach(t=>Ua.get(t).onCastStateChanged?.(e))}),Za().addEventListener(fo.CastContextEventType.SESSION_STATE_CHANGED,e=>{lo.forEach(t=>Ua.get(t).onSessionStateChanged?.(e))}),lo.forEach(e=>Ua.get(e).init?.()))});var po=0,mo=class extends EventTarget{#e;#t;#n;#r;#i=`disconnected`;#a=!1;#o=new Set;#s=new WeakMap;constructor(e){super(),this.#e=e,lo.add(this),Ua.set(this,{init:()=>this.#p(),onCastStateChanged:()=>this.#d(),onSessionStateChanged:()=>this.#f(),getCastPlayer:()=>this.#c}),this.#p()}get#c(){if(uo.has(this.#e))return this.#n}get state(){return this.#i}async watchAvailability(e){if(this.#e.disableRemotePlayback)throw new Wa(`disableRemotePlayback attribute is present.`);return this.#s.set(e,++po),this.#o.add(e),queueMicrotask(()=>e(this.#u())),po}async cancelWatchAvailability(e){if(this.#e.disableRemotePlayback)throw new Wa(`disableRemotePlayback attribute is present.`);e?this.#o.delete(e):this.#o.clear()}async prompt(){if(this.#e.disableRemotePlayback)throw new Wa(`disableRemotePlayback attribute is present.`);if(!globalThis.chrome?.cast?.isAvailable)throw new Ga(`The RemotePlayback API is disabled on this platform.`);let e=uo.has(this.#e);uo.add(this.#e),no(this.#e.castOptions),Object.entries(this.#r).forEach(([e,t])=>{this.#n.controller.addEventListener(e,t)});try{await Za().requestSession()}catch(t){if(e||uo.delete(this.#e),t===`cancel`)return;throw Error(t)}Ua.get(this.#e)?.loadOnPrompt?.()}#l(){uo.has(this.#e)&&(Object.entries(this.#r).forEach(([e,t])=>{this.#n.controller.removeEventListener(e,t)}),uo.delete(this.#e),this.#e.muted=this.#n.isMuted,this.#e.currentTime=this.#n.savedPlayerState.currentTime,this.#n.savedPlayerState.isPaused===!1&&this.#e.play())}#u(){let e=Za()?.getCastState();return e&&e!==`NO_DEVICES_AVAILABLE`}#d(){let e=Za().getCastState();if(uo.has(this.#e)&&e===`CONNECTING`&&(this.#i=`connecting`,this.dispatchEvent(new Event(`connecting`))),!this.#a&&e?.includes(`CONNECT`)){this.#a=!0;for(let e of this.#o)e(!0)}else if(this.#a&&(!e||e===`NO_DEVICES_AVAILABLE`)){this.#a=!1;for(let e of this.#o)e(!1)}}async#f(){let{SESSION_RESUMED:e}=fo.SessionState;if(Za().getSessionState()===e&&this.#e.castSrc===$a()?.media.contentId){uo.add(this.#e),Object.entries(this.#r).forEach(([e,t])=>{this.#n.controller.addEventListener(e,t)});try{await to(new chrome.cast.media.GetStatusRequest)}catch(e){console.error(e)}this.#r[fo.RemotePlayerEventType.IS_PAUSED_CHANGED](),this.#r[fo.RemotePlayerEventType.PLAYER_STATE_CHANGED]()}}#p(){!fo||this.#t||(this.#t=!0,no(this.#e.castOptions),this.#e.textTracks.addEventListener(`change`,()=>this.#h()),this.#d(),this.#n=new fo.RemotePlayer,new fo.RemotePlayerController(this.#n),this.#r={[fo.RemotePlayerEventType.IS_CONNECTED_CHANGED]:({value:e})=>{e===!0?(this.#i=`connected`,this.dispatchEvent(new Event(`connect`))):(this.#l(),this.#i=`disconnected`,this.dispatchEvent(new Event(`disconnect`)))},[fo.RemotePlayerEventType.DURATION_CHANGED]:()=>{this.#e.dispatchEvent(new Event(`durationchange`))},[fo.RemotePlayerEventType.VOLUME_LEVEL_CHANGED]:()=>{this.#e.dispatchEvent(new Event(`volumechange`))},[fo.RemotePlayerEventType.IS_MUTED_CHANGED]:()=>{this.#e.dispatchEvent(new Event(`volumechange`))},[fo.RemotePlayerEventType.CURRENT_TIME_CHANGED]:()=>{this.#c?.isMediaLoaded&&this.#e.dispatchEvent(new Event(`timeupdate`))},[fo.RemotePlayerEventType.VIDEO_INFO_CHANGED]:()=>{this.#e.dispatchEvent(new Event(`resize`))},[fo.RemotePlayerEventType.IS_PAUSED_CHANGED]:()=>{this.#e.dispatchEvent(new Event(this.paused?`pause`:`play`))},[fo.RemotePlayerEventType.PLAYER_STATE_CHANGED]:()=>{this.#c?.playerState!==chrome.cast.media.PlayerState.PAUSED&&this.#e.dispatchEvent(new Event({[chrome.cast.media.PlayerState.PLAYING]:`playing`,[chrome.cast.media.PlayerState.BUFFERING]:`waiting`,[chrome.cast.media.PlayerState.IDLE]:`emptied`}[this.#c?.playerState]))},[fo.RemotePlayerEventType.IS_MEDIA_LOADED_CHANGED]:async()=>{this.#c?.isMediaLoaded&&(await Promise.resolve(),this.#m())}})}#m(){this.#h()}async#h(){if(!this.#c)return;let e=(this.#n.mediaInfo?.tracks??[]).filter(({type:e})=>e===chrome.cast.media.TrackType.TEXT),t=[...this.#e.textTracks].filter(({kind:e})=>e===`subtitles`||e===`captions`),n=e.map(({language:e,name:n,trackId:r})=>{let{mode:i}=t.find(t=>t.language===e&&t.label===n)??{};return i?{mode:i,trackId:r}:!1}).filter(Boolean),r=n.filter(({mode:e})=>e!==`showing`).map(({trackId:e})=>e),i=n.find(({mode:e})=>e===`showing`),a=Qa()?.getSessionObj().media[0]?.activeTrackIds??[],o=a;if(a.length&&(o=o.filter(e=>!r.includes(e))),i?.trackId&&(o=[...o,i.trackId]),o=[...new Set(o)],!((e,t)=>e.length===t.length&&e.every(e=>t.includes(e)))(a,o))try{await eo(new chrome.cast.media.EditTracksInfoRequest(o))}catch(e){console.error(e)}}};const ho=e=>class extends e{static observedAttributes=[...e.observedAttributes??[],`cast-src`,`cast-content-type`,`cast-stream-type`,`cast-receiver`];#e={paused:!1};#t=ro();#n;#r;get remote(){return this.#r?this.#r:Ya()?(this.disableRemotePlayback||Xa(),Ua.set(this,{loadOnPrompt:()=>this.#a()}),this.#r=new mo(this)):super.remote}get#i(){return Ua.get(this.remote)?.getCastPlayer?.()}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),e===`cast-receiver`&&n){this.#t.receiverApplicationId=n;return}if(this.#i)switch(e){case`cast-stream-type`:case`cast-src`:this.load();break}}async#a(){this.#e.paused=super.paused,super.pause(),this.muted=super.muted;try{await this.load()}catch(e){console.error(e)}}async load(){if(!this.#i)return super.load();let e=new chrome.cast.media.MediaInfo(this.castSrc,this.castContentType);e.customData=this.castCustomData;let t=[...this.querySelectorAll(`track`)].filter(({kind:e,src:t})=>t&&(e===`subtitles`||e===`captions`)),n=[],r=0;if(t.length&&(e.tracks=t.map(e=>{let t=++r;n.length===0&&e.track.mode===`showing`&&n.push(t);let i=new chrome.cast.media.Track(t,chrome.cast.media.TrackType.TEXT);return i.trackContentId=e.src,i.trackContentType=`text/vtt`,i.subtype=e.kind===`captions`?chrome.cast.media.TextTrackType.CAPTIONS:chrome.cast.media.TextTrackType.SUBTITLES,i.name=e.label,i.language=e.srclang,i})),this.castStreamType===`live`?e.streamType=chrome.cast.media.StreamType.LIVE:e.streamType=chrome.cast.media.StreamType.BUFFERED,e.metadata=new chrome.cast.media.GenericMediaMetadata,e.metadata.title=this.title,e.metadata.images=[{url:this.poster}],so(this.castSrc)){let t=await co(this.castSrc);t?.includes(`m4s`)||t?.includes(`mp4`)?(e.hlsSegmentFormat=chrome.cast.media.HlsSegmentFormat.FMP4,e.hlsVideoSegmentFormat=chrome.cast.media.HlsVideoSegmentFormat.FMP4):t?.includes(`ts`)&&(e.hlsSegmentFormat=chrome.cast.media.HlsSegmentFormat.TS,e.hlsVideoSegmentFormat=chrome.cast.media.HlsVideoSegmentFormat.TS)}let i=new chrome.cast.media.LoadRequest(e);i.currentTime=super.currentTime??0,i.autoplay=!this.#e.paused,i.activeTrackIds=n,await Qa()?.loadMedia(i),this.dispatchEvent(new Event(`volumechange`))}play(){if(this.#i){this.#i.isPaused&&this.#i.controller?.playOrPause();return}return super.play()}pause(){if(this.#i){this.#i.isPaused||this.#i.controller?.playOrPause();return}super.pause()}get castOptions(){return this.#t}get castReceiver(){return this.getAttribute(`cast-receiver`)??void 0}set castReceiver(e){this.castReceiver!=e&&this.setAttribute(`cast-receiver`,`${e}`)}get castSrc(){return this.getAttribute(`cast-src`)??this.querySelector(`source`)?.src??this.currentSrc}set castSrc(e){this.castSrc!=e&&this.setAttribute(`cast-src`,`${e}`)}get castContentType(){return this.getAttribute(`cast-content-type`)??void 0}set castContentType(e){this.setAttribute(`cast-content-type`,`${e}`)}get castStreamType(){return this.getAttribute(`cast-stream-type`)??this.streamType??void 0}set castStreamType(e){this.setAttribute(`cast-stream-type`,`${e}`)}get castCustomData(){return this.#n}set castCustomData(e){let t=typeof e;if(![`object`,`undefined`].includes(t)){console.error(`castCustomData must be nullish or an object but value was of type ${t}`);return}this.#n=e}get readyState(){if(this.#i)switch(this.#i.playerState){case chrome.cast.media.PlayerState.IDLE:return 0;case chrome.cast.media.PlayerState.BUFFERING:return 2;default:return 3}return super.readyState}get paused(){return this.#i?this.#i.isPaused:super.paused}get muted(){return this.#i?this.#i?.isMuted:super.muted}set muted(e){if(this.#i){(e&&!this.#i.isMuted||!e&&this.#i.isMuted)&&this.#i.controller?.muteOrUnmute();return}super.muted=e}get volume(){return this.#i?this.#i?.volumeLevel??1:super.volume}set volume(e){if(this.#i){this.#i.volumeLevel=+e,this.#i.controller?.setVolumeLevel();return}super.volume=e}get duration(){return this.#i&&this.#i?.isMediaLoaded?this.#i?.duration??NaN:super.duration}get currentTime(){return this.#i&&this.#i?.isMediaLoaded?this.#i?.currentTime??0:super.currentTime}set currentTime(e){if(this.#i){this.#i.currentTime=e,this.#i.controller?.seek();return}super.currentTime=e}};var go=e=>{throw TypeError(e)},_o=(e,t,n)=>t.has(e)||go(`Cannot `+n),vo=(e,t,n)=>(_o(e,t,`read from private field`),n?n.call(e):t.get(e)),yo=(e,t,n)=>t.has(e)?go(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),bo=(e,t,n,r)=>(_o(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),xo=class{addEventListener(){}removeEventListener(){}dispatchEvent(e){return!0}};if(typeof DocumentFragment>`u`){class e extends xo{}globalThis.DocumentFragment=e}var So=class extends xo{},Co=class extends xo{},wo={get(e){},define(e,t,n){},getName(e){return null},upgrade(e){},whenDefined(e){return Promise.resolve(So)}},To,Eo=class{constructor(e,t={}){yo(this,To),bo(this,To,t?.detail)}get detail(){return vo(this,To)}initCustomEvent(){}};To=new WeakMap;function Do(e,t){return new So}var Oo={document:{createElement:Do},DocumentFragment,customElements:wo,CustomEvent:Eo,EventTarget:xo,HTMLElement:So,HTMLVideoElement:Co},ko=typeof window>`u`||globalThis.customElements===void 0,Ao=ko?Oo:globalThis;ko?Oo.document:globalThis.document;var jo,Mo=class extends ho(i(Ha)){constructor(){super(...arguments),yo(this,jo)}get autoplay(){let e=this.getAttribute(`autoplay`);return e===null?!1:e===``?!0:e}set autoplay(e){e!==this.autoplay&&(e?this.setAttribute(`autoplay`,typeof e==`string`?e:``):this.removeAttribute(`autoplay`))}get muxCastCustomData(){return{mux:{playbackId:this.playbackId,minResolution:this.minResolution,maxResolution:this.maxResolution,renditionOrder:this.renditionOrder,customDomain:this.customDomain,tokens:{drm:this.drmToken},envKey:this.envKey,metadata:this.metadata,disableCookies:this.disableCookies,disableTracking:this.disableTracking,beaconCollectionDomain:this.beaconCollectionDomain,startTime:this.startTime,preferCmcd:this.preferCmcd}}}get castCustomData(){return vo(this,jo)??this.muxCastCustomData}set castCustomData(e){bo(this,jo,e)}};jo=new WeakMap,Ao.customElements.get(`mux-video`)||(Ao.customElements.define(`mux-video`,Mo),Ao.MuxVideoElement=Mo);var k={MEDIA_PLAY_REQUEST:`mediaplayrequest`,MEDIA_PAUSE_REQUEST:`mediapauserequest`,MEDIA_MUTE_REQUEST:`mediamuterequest`,MEDIA_UNMUTE_REQUEST:`mediaunmuterequest`,MEDIA_LOOP_REQUEST:`medialooprequest`,MEDIA_VOLUME_REQUEST:`mediavolumerequest`,MEDIA_SEEK_REQUEST:`mediaseekrequest`,MEDIA_AIRPLAY_REQUEST:`mediaairplayrequest`,MEDIA_ENTER_FULLSCREEN_REQUEST:`mediaenterfullscreenrequest`,MEDIA_EXIT_FULLSCREEN_REQUEST:`mediaexitfullscreenrequest`,MEDIA_PREVIEW_REQUEST:`mediapreviewrequest`,MEDIA_ENTER_PIP_REQUEST:`mediaenterpiprequest`,MEDIA_EXIT_PIP_REQUEST:`mediaexitpiprequest`,MEDIA_ENTER_CAST_REQUEST:`mediaentercastrequest`,MEDIA_EXIT_CAST_REQUEST:`mediaexitcastrequest`,MEDIA_SHOW_TEXT_TRACKS_REQUEST:`mediashowtexttracksrequest`,MEDIA_HIDE_TEXT_TRACKS_REQUEST:`mediahidetexttracksrequest`,MEDIA_SHOW_SUBTITLES_REQUEST:`mediashowsubtitlesrequest`,MEDIA_DISABLE_SUBTITLES_REQUEST:`mediadisablesubtitlesrequest`,MEDIA_TOGGLE_SUBTITLES_REQUEST:`mediatogglesubtitlesrequest`,MEDIA_PLAYBACK_RATE_REQUEST:`mediaplaybackraterequest`,MEDIA_RENDITION_REQUEST:`mediarenditionrequest`,MEDIA_AUDIO_TRACK_REQUEST:`mediaaudiotrackrequest`,MEDIA_SEEK_TO_LIVE_REQUEST:`mediaseektoliverequest`,REGISTER_MEDIA_STATE_RECEIVER:`registermediastatereceiver`,UNREGISTER_MEDIA_STATE_RECEIVER:`unregistermediastatereceiver`},A={MEDIA_CHROME_ATTRIBUTES:`mediachromeattributes`,MEDIA_CONTROLLER:`mediacontroller`},No={MEDIA_AIRPLAY_UNAVAILABLE:`mediaAirplayUnavailable`,MEDIA_AUDIO_TRACK_ENABLED:`mediaAudioTrackEnabled`,MEDIA_AUDIO_TRACK_LIST:`mediaAudioTrackList`,MEDIA_AUDIO_TRACK_UNAVAILABLE:`mediaAudioTrackUnavailable`,MEDIA_BUFFERED:`mediaBuffered`,MEDIA_CAST_UNAVAILABLE:`mediaCastUnavailable`,MEDIA_CHAPTERS_CUES:`mediaChaptersCues`,MEDIA_CURRENT_TIME:`mediaCurrentTime`,MEDIA_DURATION:`mediaDuration`,MEDIA_ENDED:`mediaEnded`,MEDIA_ERROR:`mediaError`,MEDIA_ERROR_CODE:`mediaErrorCode`,MEDIA_ERROR_MESSAGE:`mediaErrorMessage`,MEDIA_FULLSCREEN_UNAVAILABLE:`mediaFullscreenUnavailable`,MEDIA_HAS_PLAYED:`mediaHasPlayed`,MEDIA_HEIGHT:`mediaHeight`,MEDIA_IS_AIRPLAYING:`mediaIsAirplaying`,MEDIA_IS_CASTING:`mediaIsCasting`,MEDIA_IS_FULLSCREEN:`mediaIsFullscreen`,MEDIA_IS_PIP:`mediaIsPip`,MEDIA_LOADING:`mediaLoading`,MEDIA_MUTED:`mediaMuted`,MEDIA_LOOP:`mediaLoop`,MEDIA_PAUSED:`mediaPaused`,MEDIA_PIP_UNAVAILABLE:`mediaPipUnavailable`,MEDIA_PLAYBACK_RATE:`mediaPlaybackRate`,MEDIA_PREVIEW_CHAPTER:`mediaPreviewChapter`,MEDIA_PREVIEW_COORDS:`mediaPreviewCoords`,MEDIA_PREVIEW_IMAGE:`mediaPreviewImage`,MEDIA_PREVIEW_TIME:`mediaPreviewTime`,MEDIA_RENDITION_LIST:`mediaRenditionList`,MEDIA_RENDITION_SELECTED:`mediaRenditionSelected`,MEDIA_RENDITION_UNAVAILABLE:`mediaRenditionUnavailable`,MEDIA_SEEKABLE:`mediaSeekable`,MEDIA_STREAM_TYPE:`mediaStreamType`,MEDIA_SUBTITLES_LIST:`mediaSubtitlesList`,MEDIA_SUBTITLES_SHOWING:`mediaSubtitlesShowing`,MEDIA_TARGET_LIVE_WINDOW:`mediaTargetLiveWindow`,MEDIA_TIME_IS_LIVE:`mediaTimeIsLive`,MEDIA_VOLUME:`mediaVolume`,MEDIA_VOLUME_LEVEL:`mediaVolumeLevel`,MEDIA_VOLUME_UNAVAILABLE:`mediaVolumeUnavailable`,MEDIA_LANG:`mediaLang`,MEDIA_WIDTH:`mediaWidth`},Po=Object.entries(No),j=Po.reduce((e,[t,n])=>(e[t]=n.toLowerCase(),e),{}),Fo=Po.reduce((e,[t,n])=>(e[t]=n.toLowerCase(),e),{USER_INACTIVE_CHANGE:`userinactivechange`,BREAKPOINTS_CHANGE:`breakpointchange`,BREAKPOINTS_COMPUTED:`breakpointscomputed`});Object.entries(Fo).reduce((e,[t,n])=>{let r=j[t];return r&&(e[n]=r),e},{userinactivechange:`userinactive`});var Io=Object.entries(j).reduce((e,[t,n])=>{let r=Fo[t];return r&&(e[n]=r),e},{userinactive:`userinactivechange`}),Lo={SUBTITLES:`subtitles`,CAPTIONS:`captions`,DESCRIPTIONS:`descriptions`,CHAPTERS:`chapters`,METADATA:`metadata`},Ro={DISABLED:`disabled`,HIDDEN:`hidden`,SHOWING:`showing`},zo={MOUSE:`mouse`,PEN:`pen`,TOUCH:`touch`},Bo={UNAVAILABLE:`unavailable`,UNSUPPORTED:`unsupported`},Vo={LIVE:`live`,ON_DEMAND:`on-demand`,UNKNOWN:`unknown`},Ho={INLINE:`inline`,FULLSCREEN:`fullscreen`,PICTURE_IN_PICTURE:`picture-in-picture`};function Uo(e){return e?.map(Go).join(` `)}function Wo(e){return e?.split(/\s+/).map(Ko)}function Go(e){if(e){let{id:t,width:n,height:r}=e;return[t,n,r].filter(e=>e!=null).join(`:`)}}function Ko(e){if(e){let[t,n,r]=e.split(`:`);return{id:t,width:+n,height:+r}}}function qo(e){return e?.map(Yo).join(` `)}function Jo(e){return e?.split(/\s+/).map(Xo)}function Yo(e){if(e){let{id:t,kind:n,language:r,label:i}=e;return[t,n,r,i].filter(e=>e!=null).join(`:`)}}function Xo(e){if(e){let[t,n,r,i]=e.split(`:`);return{id:t,kind:n,language:r,label:i}}}function Zo(e){return e.replace(/[-_]([a-z])/g,(e,t)=>t.toUpperCase())}function Qo(e){return typeof e==`number`&&!Number.isNaN(e)&&Number.isFinite(e)}function $o(e){return typeof e==`string`?!isNaN(e)&&!isNaN(parseFloat(e)):!1}var es=e=>new Promise(t=>setTimeout(t,e)),ts=[{singular:`hour`,plural:`hours`},{singular:`minute`,plural:`minutes`},{singular:`second`,plural:`seconds`}],ns=(e,t)=>`${e} ${e===1?ts[t].singular:ts[t].plural}`,rs=e=>{if(!Qo(e))return``;let t=Math.abs(e),n=t!==e,r=new Date(0,0,0,0,0,t,0);return`${[r.getHours(),r.getMinutes(),r.getSeconds()].map((e,t)=>e&&ns(e,t)).filter(e=>e).join(`, `)}${n?` remaining`:``}`};function is(e,t){let n=!1;e<0&&(n=!0,e=0-e),e=e<0?0:e;let r=Math.floor(e%60),i=Math.floor(e/60%60),a=Math.floor(e/3600),o=Math.floor(t/60%60),s=Math.floor(t/3600);return(isNaN(e)||e===1/0)&&(a=i=r=`0`),a=a>0||s>0?a+`:`:``,i=((a||o>=10)&&i<10?`0`+i:i)+`:`,r=r<10?`0`+r:r,(n?`-`:``)+a+i+r}Object.freeze({length:0,start(e){let t=e>>>0;if(t>=this.length)throw new DOMException(`Failed to execute 'start' on 'TimeRanges': The index provided (${t}) is greater than or equal to the maximum bound (${this.length}).`);return 0},end(e){let t=e>>>0;if(t>=this.length)throw new DOMException(`Failed to execute 'end' on 'TimeRanges': The index provided (${t}) is greater than or equal to the maximum bound (${this.length}).`);return 0}});var as={en:{"Start airplay":`Start airplay`,"Stop airplay":`Stop airplay`,Audio:`Audio`,Captions:`Captions`,"Enable captions":`Enable captions`,"Disable captions":`Disable captions`,"Start casting":`Start casting`,"Stop casting":`Stop casting`,"Enter fullscreen mode":`Enter fullscreen mode`,"Exit fullscreen mode":`Exit fullscreen mode`,Mute:`Mute`,Unmute:`Unmute`,Loop:`Loop`,"Enter picture in picture mode":`Enter picture in picture mode`,"Exit picture in picture mode":`Exit picture in picture mode`,Play:`Play`,Pause:`Pause`,"Playback rate":`Playback rate`,"Playback rate {playbackRate}":`Playback rate {playbackRate}`,Quality:`Quality`,"Seek backward":`Seek backward`,"Seek forward":`Seek forward`,Settings:`Settings`,Auto:`Auto`,"audio player":`audio player`,"video player":`video player`,volume:`volume`,seek:`seek`,"closed captions":`closed captions`,"current playback rate":`current playback rate`,"playback time":`playback time`,"media loading":`media loading`,settings:`settings`,"audio tracks":`audio tracks`,quality:`quality`,play:`play`,pause:`pause`,mute:`mute`,unmute:`unmute`,"chapter: {chapterName}":`chapter: {chapterName}`,live:`live`,Off:`Off`,"start airplay":`start airplay`,"stop airplay":`stop airplay`,"start casting":`start casting`,"stop casting":`stop casting`,"enter fullscreen mode":`enter fullscreen mode`,"exit fullscreen mode":`exit fullscreen mode`,"enter picture in picture mode":`enter picture in picture mode`,"exit picture in picture mode":`exit picture in picture mode`,"seek to live":`seek to live`,"playing live":`playing live`,"seek back {seekOffset} seconds":`seek back {seekOffset} seconds`,"seek forward {seekOffset} seconds":`seek forward {seekOffset} seconds`,"Network Error":`Network Error`,"Decode Error":`Decode Error`,"Source Not Supported":`Source Not Supported`,"Encryption Error":`Encryption Error`,"A network error caused the media download to fail.":`A network error caused the media download to fail.`,"A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.":`A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.`,"An unsupported error occurred. The server or network failed, or your browser does not support this format.":`An unsupported error occurred. The server or network failed, or your browser does not support this format.`,"The media is encrypted and there are no keys to decrypt it.":`The media is encrypted and there are no keys to decrypt it.`}},os=globalThis.navigator?.language||`en`,ss=e=>{os=e},cs=e=>{let[t]=os.split(`-`);return as[os]?.[e]||as[t]?.[e]||as.en?.[e]||e},M=(e,t={})=>cs(e).replace(/\{(\w+)\}/g,(e,n)=>n in t?String(t[n]):`{${n}}`),ls=class{addEventListener(){}removeEventListener(){}dispatchEvent(){return!0}},us=class extends ls{},ds=class extends us{constructor(){super(...arguments),this.role=null}},fs=class{observe(){}unobserve(){}disconnect(){}},ps={createElement:function(){return new ms.HTMLElement},createElementNS:function(){return new ms.HTMLElement},addEventListener(){},removeEventListener(){},dispatchEvent(e){return!1}},ms={ResizeObserver:fs,document:ps,Node:us,Element:ds,HTMLElement:class extends ds{constructor(){super(...arguments),this.innerHTML=``}get content(){return new ms.DocumentFragment}},DocumentFragment:class extends ls{},customElements:{get:function(){},define:function(){},whenDefined:function(){}},localStorage:{getItem(e){return null},setItem(e,t){},removeItem(e){}},CustomEvent:function(){},getComputedStyle:function(){},navigator:{languages:[],get userAgent(){return``}},matchMedia(e){return{matches:!1,media:e}},DOMParser:class{parseFromString(e,t){return{body:{textContent:e}}}}},hs=`global`in globalThis&&(globalThis==null?void 0:globalThis.global)===globalThis||typeof window>`u`||window.customElements===void 0,gs=Object.keys(ms).every(e=>e in globalThis),N=hs&&!gs?ms:globalThis,_s=hs&&!gs?ps:globalThis.document,vs=new WeakMap,ys=e=>{let t=vs.get(e);return t||vs.set(e,t=new Set),t},bs=new N.ResizeObserver(e=>{for(let t of e)for(let e of ys(t.target))e(t)});function xs(e,t){ys(e).add(t),bs.observe(e)}function Ss(e,t){let n=ys(e);n.delete(t),n.size||bs.unobserve(e)}function Cs(e){let t={};for(let n of e)t[n.name]=n.value;return t}function ws(e){return Ts(e)??As(e,`media-controller`)}function Ts(e){let{MEDIA_CONTROLLER:t}=A,n=e.getAttribute(t);if(n)return Ms(e)?.getElementById(n)}var Es=(e,t,n=`.value`)=>{let r=e.querySelector(n);r&&(r.textContent=t)},Ds=(e,t)=>{let n=`slot[name="${t}"]`,r=e.shadowRoot.querySelector(n);return r?r.children:[]},Os=(e,t)=>Ds(e,t)[0],ks=(e,t)=>!e||!t?!1:e?.contains(t)?!0:ks(e,t.getRootNode().host),As=(e,t)=>e?e.closest(t)||As(e.getRootNode().host,t):null;function js(e=document){let t=e?.activeElement;return t?js(t.shadowRoot)??t:null}function Ms(e){let t=(e?.getRootNode)?.call(e);return t instanceof ShadowRoot||t instanceof Document?t:null}function Ns(e,{depth:t=3,checkOpacity:n=!0,checkVisibilityCSS:r=!0}={}){if(e.checkVisibility)return e.checkVisibility({checkOpacity:n,checkVisibilityCSS:r});let i=e;for(;i&&t>0;){let e=getComputedStyle(i);if(n&&e.opacity===`0`||r&&e.visibility===`hidden`||e.display===`none`)return!1;i=i.parentElement,t--}return!0}function Ps(e,t,n,r){let i=r.x-n.x,a=r.y-n.y,o=i*i+a*a;if(o===0)return 0;let s=((e-n.x)*i+(t-n.y)*a)/o;return Math.max(0,Math.min(1,s))}function Fs(e,t){return Is(e,e=>e===t)||Ls(e,t)}function Is(e,t){let n;for(n of e.querySelectorAll(`style:not([media])`)??[]){let e;try{e=n.sheet?.cssRules}catch{continue}for(let n of e??[])if(t(n.selectorText))return n}}function Ls(e,t){let n=e.querySelectorAll(`style:not([media])`)??[],r=n?.[n.length-1];return r?.sheet?(r?.sheet.insertRule(`${t}{}`,r.sheet.cssRules.length),r.sheet.cssRules?.[r.sheet.cssRules.length-1]):(console.warn(`Media Chrome: No style sheet found on style tag of`,e),{style:{setProperty:()=>{},removeProperty:()=>``,getPropertyValue:()=>``}})}function P(e,t,n=NaN){let r=e.getAttribute(t);return r==null?n:+r}function F(e,t,n){let r=+n;if(n==null||Number.isNaN(r)){e.hasAttribute(t)&&e.removeAttribute(t);return}P(e,t,void 0)!==r&&e.setAttribute(t,`${r}`)}function I(e,t){return e.hasAttribute(t)}function L(e,t,n){if(n==null){e.hasAttribute(t)&&e.removeAttribute(t);return}I(e,t)!=n&&e.toggleAttribute(t,n)}function R(e,t,n=null){return e.getAttribute(t)??n}function z(e,t,n){if(n==null){e.hasAttribute(t)&&e.removeAttribute(t);return}let r=`${n}`;R(e,t,void 0)!==r&&e.setAttribute(t,r)}var Rs=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},zs=(e,t,n)=>(Rs(e,t,`read from private field`),n?n.call(e):t.get(e)),Bs=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Vs=(e,t,n,r)=>(Rs(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Hs;function Us(e){return`
  ...
  `}function Au(e,t){return`
    <slot></slot>
  `}function ju(){return``}var Mu=class extends N.HTMLElement{constructor(){if(super(),vu(this,Eu),vu(this,xu,void 0),this.preventClick=!1,this.tooltipEl=null,vu(this,Su,e=>{this.preventClick||this.handleClick(e),setTimeout(_u(this,Cu),0)}),vu(this,Cu,()=>{var e,t;(t=(e=this.tooltipEl)?.updateXOffset)==null||t.call(e)}),vu(this,wu,e=>{let{key:t}=e;if(!this.keysUsed.includes(t)){this.removeEventListener(`keyup`,_u(this,wu));return}this.preventClick||this.handleClick(e)}),vu(this,Tu,e=>{let{metaKey:t,altKey:n,key:r}=e;if(t||n||!this.keysUsed.includes(r)){this.removeEventListener(`keyup`,_u(this,wu));return}this.addEventListener(`keyup`,_u(this,wu),{once:!0})}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Cs(this.attributes),t=this.constructor.getTemplateHTML(e);this.shadowRoot.setHTMLUnsafe?this.shadowRoot.setHTMLUnsafe(t):this.shadowRoot.innerHTML=t}this.tooltipEl=this.shadowRoot.querySelector(`media-tooltip`)}static get observedAttributes(){return[`disabled`,Ou.TOOLTIP_PLACEMENT,A.MEDIA_CONTROLLER,j.MEDIA_LANG]}enable(){this.addEventListener(`click`,_u(this,Su)),this.addEventListener(`keydown`,_u(this,Tu)),this.tabIndex=0}disable(){this.removeEventListener(`click`,_u(this,Su)),this.removeEventListener(`keydown`,_u(this,Tu)),this.removeEventListener(`keyup`,_u(this,wu)),this.tabIndex=-1}attributeChangedCallback(e,t,n){var r,i,a,o;e===A.MEDIA_CONTROLLER?(t&&((i=(r=_u(this,xu))?.unassociateElement)==null||i.call(r,this),yu(this,xu,null)),n&&this.isConnected&&(yu(this,xu,this.getRootNode()?.getElementById(n)),(o=(a=_u(this,xu))?.associateElement)==null||o.call(a,this))):e===`disabled`&&n!==t?n==null?this.enable():this.disable():e===Ou.TOOLTIP_PLACEMENT&&this.tooltipEl&&n!==t?this.tooltipEl.placement=n:e===j.MEDIA_LANG&&(this.shadowRoot.querySelector(`slot[name="tooltip-content"]`).innerHTML=this.constructor.getTooltipContentHTML()),_u(this,Cu).call(this)}connectedCallback(){var e,t;let{style:n}=Fs(this.shadowRoot,`:host`);n.setProperty(`display`,`var(--media-control-display, var(--${this.localName}-display, inline-flex))`),this.hasAttribute(`disabled`)?this.disable():this.enable(),this.setAttribute(`role`,`button`);let r=this.getAttribute(A.MEDIA_CONTROLLER);r&&(yu(this,xu,this.getRootNode()?.getElementById(r)),(t=(e=_u(this,xu))?.associateElement)==null||t.call(e,this)),N.customElements.whenDefined(`media-tooltip`).then(()=>bu(this,Eu,Du).call(this))}disconnectedCallback(){var e,t;this.disable(),(t=(e=_u(this,xu))?.unassociateElement)==null||t.call(e,this),yu(this,xu,null),this.removeEventListener(`mouseenter`,_u(this,Cu)),this.removeEventListener(`focus`,_u(this,Cu)),this.removeEventListener(`click`,_u(this,Su))}get keysUsed(){return[`Enter`,` `]}get tooltipPlacement(){return R(this,Ou.TOOLTIP_PLACEMENT)}set tooltipPlacement(e){z(this,Ou.TOOLTIP_PLACEMENT,e)}get mediaController(){return R(this,A.MEDIA_CONTROLLER)}set mediaController(e){z(this,A.MEDIA_CONTROLLER,e)}get disabled(){return I(this,Ou.DISABLED)}set disabled(e){L(this,Ou.DISABLED,e)}get noTooltip(){return I(this,Ou.NO_TOOLTIP)}set noTooltip(e){L(this,Ou.NO_TOOLTIP,e)}handleClick(e){}};xu=new WeakMap,Su=new WeakMap,Cu=new WeakMap,wu=new WeakMap,Tu=new WeakMap,Eu=new WeakSet,Du=function(){this.addEventListener(`mouseenter`,_u(this,Cu)),this.addEventListener(`focus`,_u(this,Cu)),this.addEventListener(`click`,_u(this,Su));let e=this.tooltipPlacement;e&&this.tooltipEl&&(this.tooltipEl.placement=e)},Mu.shadowRootOptions={mode:`open`},Mu.getTemplateHTML=ku,Mu.getSlotTemplateHTML=Au,Mu.getTooltipContentHTML=ju,N.customElements.get(`media-chrome-button`)||N.customElements.define(`media-chrome-button`,Mu);var Nu=`<svg aria-hidden="true" viewBox="0 0 26 24">
...
`;function Pu(e){return`
    ...
    <slot name="icon">
      ...
      <slot name="exit">${Nu}</slot>
    </slot>
  `}function Fu(){return`
    <slot name="tooltip-enter">${M(`start airplay`)}</slot>
    <slot name="tooltip-exit">${M(`stop airplay`)}</slot>
  `}var Iu=e=>{let t=e.mediaIsAirplaying?M(`stop airplay`):M(`start airplay`);e.setAttribute(`aria-label`,t)},Lu=class extends Mu{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_IS_AIRPLAYING,j.MEDIA_AIRPLAY_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),Iu(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_IS_AIRPLAYING&&Iu(this)}get mediaIsAirplaying(){return I(this,j.MEDIA_IS_AIRPLAYING)}set mediaIsAirplaying(e){L(this,j.MEDIA_IS_AIRPLAYING,e)}get mediaAirplayUnavailable(){return R(this,j.MEDIA_AIRPLAY_UNAVAILABLE)}set mediaAirplayUnavailable(e){z(this,j.MEDIA_AIRPLAY_UNAVAILABLE,e)}handleClick(){let e=new N.CustomEvent(k.MEDIA_AIRPLAY_REQUEST,{composed:!0,bubbles:!0});this.dispatchEvent(e)}};Lu.getSlotTemplateHTML=Pu,Lu.getTooltipContentHTML=Fu,N.customElements.get(`media-airplay-button`)||N.customElements.define(`media-airplay-button`,Lu);var Ru=`<svg aria-hidden="true" viewBox="0 0 26 24">
...
</svg>`,zu=`<svg aria-hidden="true" viewBox="0 0 26 24">
  <path d="M17.73 14.09a1.4 1.4 0 0 1-1 .37 1.579 1.579 0 0 1-1.27-.58A3 3 0 0 1 15 12a2.8 2.8 0 0 1 .5-1.85 1.63 1.63 0 0 1 1.29-.57 1.47 1.47 0 0 1 1.51 1.2l1.43-.34A2.89 2.89 0 0 0 19 9.07a3 3 0 0 0-2.14-.78 3.14 3.14 0 0 0-2.42 1 3.91 3.91 0 0 0-.93 2.78 3.74 3.74 0 0 0 .92 2.66 3.07 3.07 0 0 0 2.34 1 3.07 3.07 0 0 0 1.91-.57 3.17 3.17 0 0 0 1.07-1.74l-1.4-.45c-.083.43-.3.822-.62 1.12Zm-7.22 0a1.43 1.43 0 0 1-1 .37 1.58 1.58 0 0 1-1.27-.58A3 3 0 0 1 7.76 12a2.8 2.8 0 0 1 .5-1.85 1.63 1.63 0 0 1 1.29-.57 1.47 1.47 0 0 1 1.51 1.2l1.43-.34a2.81 2.81 0 0 0-.74-1.32 2.94 2.94 0 0 0-2.13-.78 3.18 3.18 0 0 0-2.43 1 4 4 0 0 0-.92 2.78 3.74 3.74 0 0 0 .92 2.66 3.07 3.07 0 0 0 2.34 1 3.07 3.07 0 0 0 1.91-.57 3.23 3.23 0 0 0 1.07-1.74l-1.4-.45a2.06 2.06 0 0 1-.6 1.07Zm12.32-8.41a2.59 2.59 0 0 0-2.3-2.51C18.72 3.05 15.86 3 13 3c-2.86 0-5.72.05-7.53.17a2.59 2.59 0 0 0-2.3 2.51c-.23 4.207-.23 8.423 0 12.63a2.57 2.57 0 0 0 2.3 2.5c1.81.13 4.67.19 7.53.19 2.86 0 5.72-.06 7.53-.19a2.57 2.57 0 0 0 2.3-2.5c.23-4.207.23-8.423 0-12.63Zm-1.49 12.53a1.11 1.11 0 0 1-.91 1.11c-1.67.11-4.45.18-7.43.18-2.98 0-5.76-.07-7.43-.18a1.11 1.11 0 0 1-.91-1.11c-.21-4.14-.21-8.29 0-12.43a1.11 1.11 0 0 1 .91-1.11C7.24 4.56 10 4.49 13 4.49s5.76.07 7.43.18a1.11 1.11 0 0 1 .91 1.11c.21 4.14.21 8.29 0 12.43Z"/>
    ...
    <slot name="icon">
      ...
      <slot name="off">${zu}</slot>
    </slot>
  `}function Vu(){return`
    <slot name="tooltip-enable">${M(`Enable captions`)}</slot>
    <slot name="tooltip-disable">${M(`Disable captions`)}</slot>
  `}var Hu=e=>{e.setAttribute(`aria-checked`,Kc(e).toString())},Uu=class extends Mu{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_SUBTITLES_LIST,j.MEDIA_SUBTITLES_SHOWING]}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`switch`),this.setAttribute(`aria-label`,M(`closed captions`)),Hu(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_SUBTITLES_SHOWING&&Hu(this)}get mediaSubtitlesList(){return Wu(this,j.MEDIA_SUBTITLES_LIST)}set mediaSubtitlesList(e){Gu(this,j.MEDIA_SUBTITLES_LIST,e)}get mediaSubtitlesShowing(){return Wu(this,j.MEDIA_SUBTITLES_SHOWING)}set mediaSubtitlesShowing(e){Gu(this,j.MEDIA_SUBTITLES_SHOWING,e)}handleClick(){this.dispatchEvent(new N.CustomEvent(k.MEDIA_TOGGLE_SUBTITLES_REQUEST,{composed:!0,bubbles:!0}))}};Uu.getSlotTemplateHTML=Bu,Uu.getTooltipContentHTML=Vu;var Wu=(e,t)=>{let n=e.getAttribute(t);return n?Rc(n):[]},Gu=(e,t,n)=>{if(!n?.length){e.removeAttribute(t);return}let r=Vc(n);e.getAttribute(t)!==r&&e.setAttribute(t,r)};N.customElements.get(`media-captions-button`)||N.customElements.define(`media-captions-button`,Uu);var Ku=`<svg aria-hidden="true" viewBox="0 0 24 24"><g><path class="cast_caf_icon_arch0" d="M1,18 L1,21 L4,21 C4,19.3 2.66,18 1,18 L1,18 Z"/><path class="cast_caf_icon_arch1" d="M1,14 L1,16 C3.76,16 6,18.2 6,21 L8,21 C8,17.13 4.87,14 1,14 L1,14 Z"/><path class="cast_caf_icon_arch2" d="M1,10 L1,12 C5.97,12 10,16.0 10,21 L12,21 C12,14.92 7.07,10 1,10 L1,10 Z"/><path class="cast_caf_icon_box" d="M21,3 L3,3 C1.9,3 1,3.9 1,5 L1,8 L3,8 L3,5 L21,5 L21,19 L14,19 L14,21 L21,21 C22.1,21 23,20.1 23,19 L23,5 C23,3.9 22.1,3 21,3 L21,3 Z"/></g></svg>`,qu=`<svg aria-hidden="true" viewBox="0 0 24 24"><g><path class="cast_caf_icon_arch0" d="M1,18 L1,21 L4,21 C4,19.3 2.66,18 1,18 L1,18 Z"/><path class="cast_caf_icon_arch1" d="M1,14 L1,16 C3.76,16 6,18.2 6,21 L8,21 C8,17.13 4.87,14 1,14 L1,14 Z"/><path class="cast_caf_icon_arch2" d="M1,10 L1,12 C5.97,12 10,16.0 10,21 L12,21 C12,14.92 7.07,10 1,10 L1,10 Z"/><path class="cast_caf_icon_box" d="M21,3 L3,3 C1.9,3 1,3.9 1,5 L1,8 L3,8 L3,5 L21,5 L21,19 L14,19 L14,21 L21,21 C22.1,21 23,20.1 23,19 L23,5 C23,3.9 22.1,3 21,3 L21,3 Z"/><path class="cast_caf_icon_boxfill" d="M5,7 L5,8.63 C8,8.6 13.37,14 13.37,17 L19,17 L19,7 Z"/></g></svg>`;function Ju(e){return`
    <style>
  ...
  `}var Xu=e=>{let t=e.mediaIsCasting?M(`stop casting`):M(`start casting`);e.setAttribute(`aria-label`,t)},Zu=class extends Mu{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_IS_CASTING,j.MEDIA_CAST_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),Xu(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_IS_CASTING&&Xu(this)}get mediaIsCasting(){return I(this,j.MEDIA_IS_CASTING)}set mediaIsCasting(e){L(this,j.MEDIA_IS_CASTING,e)}get mediaCastUnavailable(){return R(this,j.MEDIA_CAST_UNAVAILABLE)}set mediaCastUnavailable(e){z(this,j.MEDIA_CAST_UNAVAILABLE,e)}handleClick(){let e=this.mediaIsCasting?k.MEDIA_EXIT_CAST_REQUEST:k.MEDIA_ENTER_CAST_REQUEST;this.dispatchEvent(new N.CustomEvent(e,{composed:!0,bubbles:!0}))}};Zu.getSlotTemplateHTML=Ju,Zu.getTooltipContentHTML=Yu,N.customElements.get(`media-cast-button`)||N.customElements.define(`media-cast-button`,Zu);var Qu=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},$u=(e,t,n)=>(Qu(e,t,`read from private field`),n?n.call(e):t.get(e)),ed=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},td=(e,t,n,r)=>(Qu(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),nd=(e,t,n)=>(Qu(e,t,`access private method`),n),rd,id,ad,od,sd,cd,ld,ud,dd,fd,pd,md,hd,gd,_d;function vd(e){return`
    <style>
      :host {
        font: var(--media-font,
  ...
  `}var bd={OPEN:`open`,ANCHOR:`anchor`},xd=class extends N.HTMLElement{constructor(){super(),ed(this,od),ed(this,cd),ed(this,ud),ed(this,fd),ed(this,md),ed(this,gd),ed(this,rd,!1),ed(this,id,null),ed(this,ad,null),this.addEventListener(`invoke`,this),this.addEventListener(`focusout`,this),this.addEventListener(`keydown`,this)}static get observedAttributes(){return[bd.OPEN,bd.ANCHOR]}get open(){return I(this,bd.OPEN)}set open(e){L(this,bd.OPEN,e)}handleEvent(e){switch(e.type){case`invoke`:nd(this,fd,pd).call(this,e);break;case`focusout`:nd(this,md,hd).call(this,e);break;case`keydown`:nd(this,gd,_d).call(this,e);break}}connectedCallback(){nd(this,od,sd).call(this),this.role||=`dialog`}attributeChangedCallback(e,t,n){nd(this,od,sd).call(this),e===bd.OPEN&&n!==t&&(this.open?nd(this,cd,ld).call(this):nd(this,ud,dd).call(this))}focus(){td(this,id,js());let e=!this.dispatchEvent(new Event(`focus`,{composed:!0,cancelable:!0})),t=!this.dispatchEvent(new Event(`focusin`,{composed:!0,bubbles:!0,cancelable:!0}));e||t||this.querySelector(`[autofocus], [tabindex]:not([tabindex="-1"]), [role="menu"]`)?.focus()}get keysUsed(){return[`Escape`,`Tab`]}};rd=new WeakMap,id=new WeakMap,ad=new WeakMap,od=new WeakSet,sd=function(){if(!$u(this,rd)&&(td(this,rd,!0),!this.shadowRoot)){this.attachShadow(this.constructor.shadowRootOptions);let e=Cs(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e),queueMicrotask(()=>{let{style:e}=Fs(this.shadowRoot,`:host`);e.setProperty(`transition`,`display .15s, visibility .15s, opacity .15s ease-in, transform .15s ease-in`)})}},cd=new WeakSet,ld=function(){var e;(e=$u(this,ad))==null||e.setAttribute(`aria-expanded`,`true`),this.dispatchEvent(new Event(`open`,{composed:!0,bubbles:!0})),this.addEventListener(`transitionend`,()=>this.focus(),{once:!0})},ud=new WeakSet,dd=function(){var e;(e=$u(this,ad))==null||e.setAttribute(`aria-expanded`,`false`),this.dispatchEvent(new Event(`close`,{composed:!0,bubbles:!0}))},fd=new WeakSet,pd=function(e){td(this,ad,e.relatedTarget),ks(this,e.relatedTarget)||(this.open=!this.open)},md=new WeakSet,hd=function(e){var t;ks(this,e.relatedTarget)||((t=$u(this,id))==null||t.focus(),$u(this,ad)&&$u(this,ad)!==e.relatedTarget&&this.open&&(this.open=!1))},gd=new WeakSet,_d=function(e){var t,n,r,i,a;let{key:o,ctrlKey:s,altKey:c,metaKey:l}=e;s||c||l||this.keysUsed.includes(o)&&(e.preventDefault(),e.stopPropagation(),o===`Tab`?(e.shiftKey?(n=(t=this.previousElementSibling)?.focus)==null||n.call(t):(i=(r=this.nextElementSibling)?.focus)==null||i.call(r),this.blur()):o===`Escape`&&((a=$u(this,id))==null||a.focus(),this.open=!1))},xd.shadowRootOptions={mode:`open`},xd.getTemplateHTML=vd,xd.getSlotTemplateHTML=yd,N.customElements.get(`media-chrome-dialog`)||N.customElements.define(`media-chrome-dialog`,xd);var Sd=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},W=(e,t,n)=>(Sd(e,t,`read from private field`),n?n.call(e):t.get(e)),Cd=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},wd=(e,t,n,r)=>(Sd(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Td=(e,t,n)=>(Sd(e,t,`access private method`),n),Ed,Dd,Od,kd,Ad,jd,Md,Nd,Pd,Fd,Id,Ld,Rd,zd,Bd,Vd,Hd,Ud,Wd,Gd,Kd,qd,Jd,Yd,Xd;function Zd(e){return`
    <style>
      :host {
    ...
    <div id="rightgap"></div>
  `}function Qd(e){return``}var $d=class extends N.HTMLElement{constructor(){if(super(),Cd(this,Fd),Cd(this,Ld),Cd(this,zd),Cd(this,Vd),Cd(this,Ud),Cd(this,Gd),Cd(this,qd),Cd(this,Yd),Cd(this,Ed,void 0),Cd(this,Dd,void 0),Cd(this,Od,void 0),Cd(this,kd,void 0),Cd(this,Ad,{}),Cd(this,jd,[]),Cd(this,Md,()=>{if(this.range.matches(`:focus-visible`)){let{style:e}=Fs(this.shadowRoot,`:host`);e.setProperty(`--_focus-visible-box-shadow`,`var(--_focus-box-shadow)`)}}),Cd(this,Nd,()=>{let{style:e}=Fs(this.shadowRoot,`:host`);e.removeProperty(`--_focus-visible-box-shadow`)}),Cd(this,Pd,()=>{let e=this.shadowRoot.querySelector(`#segments-clipping`);e&&e.parentNode.append(e)}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Cs(this.attributes),t=this.constructor.getTemplateHTML(e);this.shadowRoot.setHTMLUnsafe?this.shadowRoot.setHTMLUnsafe(t):this.shadowRoot.innerHTML=t}this.container=this.shadowRoot.querySelector(`#container`),wd(this,Od,this.shadowRoot.querySelector(`#startpoint`)),wd(this,kd,this.shadowRoot.querySelector(`#endpoint`)),this.range=this.shadowRoot.querySelector(`#range`),this.appearance=this.shadowRoot.querySelector(`#appearance`)}static get observedAttributes(){return[`disabled`,`aria-disabled`,A.MEDIA_CONTROLLER]}attributeChangedCallback(e,t,n){var r,i,a,o;e===A.MEDIA_CONTROLLER?(t&&((i=(r=W(this,Ed))?.unassociateElement)==null||i.call(r,this),wd(this,Ed,null)),n&&this.isConnected&&(wd(this,Ed,this.getRootNode()?.getElementById(n)),(o=(a=W(this,Ed))?.associateElement)==null||o.call(a,this))):(e===`disabled`||e===`aria-disabled`&&t!==n)&&(n==null?(this.range.removeAttribute(e),Td(this,Ld,Rd).call(this)):(this.range.setAttribute(e,n),Td(this,zd,Bd).call(this)))}connectedCallback(){var e,t;let{style:n}=Fs(this.shadowRoot,`:host`);n.setProperty(`display`,`var(--media-control-display, var(--${this.localName}-display, inline-flex))`),W(this,Ad).pointer=Fs(this.shadowRoot,`#pointer`),W(this,Ad).progress=Fs(this.shadowRoot,`#progress`),W(this,Ad).thumb=Fs(this.shadowRoot,`#thumb, ::slotted([slot="thumb"])`),W(this,Ad).activeSegment=Fs(this.shadowRoot,`#segments-clipping rect:nth-child(0)`);let r=this.getAttribute(A.MEDIA_CONTROLLER);r&&(wd(this,Ed,this.getRootNode()?.getElementById(r)),(t=(e=W(this,Ed))?.associateElement)==null||t.call(e,this)),this.updateBar(),this.shadowRoot.addEventListener(`focusin`,W(this,Md)),this.shadowRoot.addEventListener(`focusout`,W(this,Nd)),Td(this,Ld,Rd).call(this),xs(this.container,W(this,Pd))}disconnectedCallback(){var e,t;Td(this,zd,Bd).call(this),(t=(e=W(this,Ed))?.unassociateElement)==null||t.call(e,this),wd(this,Ed,null),this.shadowRoot.removeEventListener(`focusin`,W(this,Md)),this.shadowRoot.removeEventListener(`focusout`,W(this,Nd)),Ss(this.container,W(this,Pd))}updatePointerBar(e){var t;(t=W(this,Ad).pointer)==null||t.style.setProperty(`width`,`${this.getPointerRatio(e)*100}%`)}updateBar(){var e,t;let n=this.range.valueAsNumber*100;(e=W(this,Ad).progress)==null||e.style.setProperty(`width`,`${n}%`),(t=W(this,Ad).thumb)==null||t.style.setProperty(`left`,`${n}%`)}updateSegments(e){let t=this.shadowRoot.querySelector(`#segments-clipping`);if(t.textContent=``,this.container.classList.toggle(`segments`,!!e?.length),!e?.length)return;let n=[...new Set([+this.range.min,...e.flatMap(e=>[e.start,e.end]),+this.range.max])];wd(this,jd,[...n]);let r=n.pop();for(let[e,i]of n.entries()){let[a,o]=[e===0,e===n.length-1],s=a?`calc(var(--segments-gap) / -1)`:`${i*100}%`,c=`calc(${((o?r:n[e+1])-i)*100}%${a||o?``:` - var(--segments-gap)`})`,l=_s.createElementNS(`http://www.w3.org/2000/svg`,`rect`),u=Ls(this.shadowRoot,`#segments-clipping rect:nth-child(${e+1})`);u.style.setProperty(`x`,s),u.style.setProperty(`width`,c),t.append(l)}}getPointerRatio(e){return Ps(e.clientX,e.clientY,W(this,Od).getBoundingClientRect(),W(this,kd).getBoundingClientRect())}get dragging(){return this.hasAttribute(`dragging`)}handleEvent(e){switch(e.type){case`pointermove`:Td(this,Yd,Xd).call(this,e);break;case`input`:this.updateBar();break;case`pointerenter`:Td(this,Ud,Wd).call(this,e);break;case`pointerdown`:Td(this,Vd,Hd).call(this,e);break;case`pointerup`:Td(this,Gd,Kd).call(this);break;case`pointerleave`:Td(this,qd,Jd).call(this);break}}get keysUsed(){return[`ArrowUp`,`ArrowRight`,`ArrowDown`,`ArrowLeft`]}};Ed=new WeakMap,Dd=new WeakMap,Od=new WeakMap,kd=new WeakMap,Ad=new WeakMap,jd=new WeakMap,Md=new WeakMap,Nd=new WeakMap,Pd=new WeakMap,Fd=new WeakSet,Id=function(e){let t=W(this,Ad).activeSegment;if(!t)return;let n=this.getPointerRatio(e),r=`#segments-clipping rect:nth-child(${W(this,jd).findIndex((e,t,r)=>{let i=r[t+1];return i!=null&&n>=e&&n<=i})+1})`;(t.selectorText!=r||!t.style.transform)&&(t.selectorText=r,t.style.setProperty(`transform`,`var(--media-range-segment-hover-transform, scaleY(2))`))},Ld=new WeakSet,Rd=function(){this.hasAttribute(`disabled`)||(this.addEventListener(`input`,this),this.addEventListener(`pointerdown`,this),this.addEventListener(`pointerenter`,this))},zd=new WeakSet,Bd=function(){var e,t;this.removeEventListener(`input`,this),this.removeEventListener(`pointerdown`,this),this.removeEventListener(`pointerenter`,this),(e=N.window)==null||e.removeEventListener(`pointerup`,this),(t=N.window)==null||t.removeEventListener(`pointermove`,this)},Vd=new WeakSet,Hd=function(e){var t;wd(this,Dd,e.composedPath().includes(this.range)),(t=N.window)==null||t.addEventListener(`pointerup`,this)},Ud=new WeakSet,Wd=function(e){var t;e.pointerType!==`mouse`&&Td(this,Vd,Hd).call(this,e),this.addEventListener(`pointerleave`,this),(t=N.window)==null||t.addEventListener(`pointermove`,this)},Gd=new WeakSet,Kd=function(){var e;(e=N.window)==null||e.removeEventListener(`pointerup`,this),this.toggleAttribute(`dragging`,!1),this.range.disabled=this.hasAttribute(`disabled`)},qd=new WeakSet,Jd=function(){var e,t;this.removeEventListener(`pointerleave`,this),(e=N.window)==null||e.removeEventListener(`pointermove`,this),this.toggleAttribute(`dragging`,!1),this.range.disabled=this.hasAttribute(`disabled`),(t=W(this,Ad).activeSegment)==null||t.style.removeProperty(`transform`)},Yd=new WeakSet,Xd=function(e){e.pointerType===`pen`&&e.buttons===0||(this.toggleAttribute(`dragging`,e.buttons===1||e.pointerType!==`mouse`),this.updatePointerBar(e),Td(this,Fd,Id).call(this,e),this.dragging&&(e.pointerType!==`mouse`||!W(this,Dd))&&(this.range.disabled=!0,this.range.valueAsNumber=this.getPointerRatio(e),this.range.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0}))))},$d.shadowRootOptions={mode:`open`},$d.getTemplateHTML=Zd,$d.getContainerTemplateHTML=Qd,N.customElements.get(`media-chrome-range`)||N.customElements.define(`media-chrome-range`,$d);var ef=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},tf=(e,t,n)=>(ef(e,t,`read from private field`),n?n.call(e):t.get(e)),nf=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},rf=(e,t,n,r)=>(ef(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),af;function of(e){return`
    <style>
      :host {
  ...
  `}var cp=e=>{let t=e.mediaPaused||!e.mediaTimeIsLive,n=M(t?`seek to live`:`playing live`);e.setAttribute(`aria-label`,n);let r=e.shadowRoot?.querySelector(`slot[name="text"]`);r&&(r.textContent=M(`live`)),t?e.removeAttribute(`aria-disabled`):e.setAttribute(`aria-disabled`,`true`)},lp=class extends Mu{static get observedAttributes(){return[...super.observedAttributes,np,rp]}connectedCallback(){super.connectedCallback(),cp(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),cp(this)}get mediaPaused(){return I(this,j.MEDIA_PAUSED)}set mediaPaused(e){L(this,j.MEDIA_PAUSED,e)}get mediaTimeIsLive(){return I(this,j.MEDIA_TIME_IS_LIVE)}set mediaTimeIsLive(e){L(this,j.MEDIA_TIME_IS_LIVE,e)}handleClick(){!this.mediaPaused&&this.mediaTimeIsLive||(this.dispatchEvent(new N.CustomEvent(ip,{composed:!0,bubbles:!0})),this.hasAttribute(rp)&&this.dispatchEvent(new N.CustomEvent(ap,{composed:!0,bubbles:!0})))}};lp.getSlotTemplateHTML=sp,N.customElements.get(`media-live-button`)||N.customElements.define(`media-live-button`,lp);var up=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},dp=(e,t,n)=>(up(e,t,`read from private field`),n?n.call(e):t.get(e)),fp=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},pp=(e,t,n,r)=>(up(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),mp,hp,gp={LOADING_DELAY:`loadingdelay`,NO_AUTOHIDE:`noautohide`},_p=500,vp=`
...
`;function yp(e){return`
  ...
  `}var Ep=e=>{let t=e.mediaVolumeLevel===`off`?M(`unmute`):M(`mute`);e.setAttribute(`aria-label`,t)},Dp=class extends Mu{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_VOLUME_LEVEL]}connectedCallback(){super.connectedCallback(),Ep(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_VOLUME_LEVEL&&Ep(this)}get mediaVolumeLevel(){return R(this,j.MEDIA_VOLUME_LEVEL)}set mediaVolumeLevel(e){z(this,j.MEDIA_VOLUME_LEVEL,e)}handleClick(){let e=this.mediaVolumeLevel===`off`?k.MEDIA_UNMUTE_REQUEST:k.MEDIA_MUTE_REQUEST;this.dispatchEvent(new N.CustomEvent(e,{composed:!0,bubbles:!0}))}};Dp.getSlotTemplateHTML=wp,Dp.getTooltipContentHTML=Tp,N.customElements.get(`media-mute-button`)||N.customElements.define(`media-mute-button`,Dp);var Op=`<svg aria-hidden="true" viewBox="0 0 28 24">
  ...
  `}function Bp(){return M(`Playback rate`)}var Vp=class extends Mu{constructor(){super(),Fp(this,Ip,new Fc(this,Lp.RATES,{defaultValue:Rp})),this.container=this.shadowRoot.querySelector(`slot[name="icon"]`),this.container.innerHTML=`${this.mediaPlaybackRate??1}x`}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PLAYBACK_RATE,Lp.RATES]}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),e===Lp.RATES&&(Pp(this,Ip).value=n),e===j.MEDIA_PLAYBACK_RATE){let e=n?+n:NaN,t=Number.isNaN(e)?1:e;this.container.innerHTML=`${t}x`,this.setAttribute(`aria-label`,M(`Playback rate {playbackRate}`,{playbackRate:t}))}}get rates(){return Pp(this,Ip)}set rates(e){e?Array.isArray(e)?Pp(this,Ip).value=e.join(` `):typeof e==`string`&&(Pp(this,Ip).value=e):Pp(this,Ip).value=``}get mediaPlaybackRate(){return P(this,j.MEDIA_PLAYBACK_RATE,1)}set mediaPlaybackRate(e){F(this,j.MEDIA_PLAYBACK_RATE,e)}handleClick(){let e=Array.from(Pp(this,Ip).values(),e=>+e).sort((e,t)=>e-t),t=e.find(e=>e>this.mediaPlaybackRate)??e[0]??1,n=new N.CustomEvent(k.MEDIA_PLAYBACK_RATE_REQUEST,{composed:!0,bubbles:!0,detail:t});this.dispatchEvent(n)}};Ip=new WeakMap,Vp.getSlotTemplateHTML=zp,Vp.getTooltipContentHTML=Bp,N.customElements.get(`media-playback-rate-button`)||N.customElements.define(`media-playback-rate-button`,Vp);var Hp=`<svg aria-hidden="true" viewBox="0 0 24 24">
  ...
  `}var Kp=e=>{let t=e.mediaPaused?M(`play`):M(`pause`);e.setAttribute(`aria-label`,t)},qp=class extends Mu{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PAUSED,j.MEDIA_ENDED]}connectedCallback(){super.connectedCallback(),Kp(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),(e===j.MEDIA_PAUSED||e===j.MEDIA_LANG)&&Kp(this)}get mediaPaused(){return I(this,j.MEDIA_PAUSED)}set mediaPaused(e){L(this,j.MEDIA_PAUSED,e)}handleClick(){let e=this.mediaPaused?k.MEDIA_PLAY_REQUEST:k.MEDIA_PAUSE_REQUEST;this.dispatchEvent(new N.CustomEvent(e,{composed:!0,bubbles:!0}))}};qp.getSlotTemplateHTML=Wp,qp.getTooltipContentHTML=Gp,N.customElements.get(`media-play-button`)||N.customElements.define(`media-play-button`,qp);var Jp={PLACEHOLDER_SRC:`placeholdersrc`,SRC:`src`};function Yp(e){return`
    <style>
      :host {
        pointer-events: none;
  ...
  `}function Cm(){return M(`Seek backward`)}var wm=0,Tm=class extends Mu{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_CURRENT_TIME,ym.SEEK_OFFSET]}connectedCallback(){super.connectedCallback(),this.seekOffset=P(this,ym.SEEK_OFFSET,bm)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===ym.SEEK_OFFSET&&(this.seekOffset=P(this,ym.SEEK_OFFSET,bm))}get seekOffset(){return P(this,ym.SEEK_OFFSET,bm)}set seekOffset(e){F(this,ym.SEEK_OFFSET,e),this.setAttribute(`aria-label`,M(`seek back {seekOffset} seconds`,{seekOffset:this.seekOffset})),Es(Os(this,`icon`),this.seekOffset)}get mediaCurrentTime(){return P(this,j.MEDIA_CURRENT_TIME,wm)}set mediaCurrentTime(e){F(this,j.MEDIA_CURRENT_TIME,e)}handleClick(){let e=Math.max(this.mediaCurrentTime-this.seekOffset,0),t=new N.CustomEvent(k.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(t)}};Tm.getSlotTemplateHTML=Sm,Tm.getTooltipContentHTML=Cm,N.customElements.get(`media-seek-backward-button`)||N.customElements.define(`media-seek-backward-button`,Tm);var Em={SEEK_OFFSET:`seekoffset`},Dm=30,Om=e=>`
  <svg aria-hidden="true" viewBox="0 0 20 24">
    <defs>
      <style>.text{font-size:8px;font-family:Arial-BoldMT, Arial;font-weight:700;}</style>
    </defs>
...
`;var r_=class extends N.HTMLElement{constructor(){super(),Gg(this,Zg),Gg(this,$g),Gg(this,Jg,void 0),Gg(this,Yg,void 0),Gg(this,Xg,void 0),this.shadowRoot?this.renderRoot=this.shadowRoot:(this.renderRoot=this.attachShadow({mode:`open`}),this.createRenderer());let e=new MutationObserver(e=>{this.mediaController&&!this.mediaController?.breakpointsComputed||e.some(e=>{let t=e.target;return t===this?!0:t.localName===`media-controller`?!!(t_[e.attributeName]||e.attributeName.startsWith(`breakpoint`)):!1})&&this.render()});e.observe(this,{attributes:!0}),e.observe(this.renderRoot,{attributes:!0,subtree:!0}),this.addEventListener(Fo.BREAKPOINTS_COMPUTED,this.render),qg(this,Zg,Qg).call(this,`template`)}get mediaController(){return this.renderRoot.querySelector(`media-controller`)}get template(){return Wg(this,Jg)??this.constructor.template}set template(e){if(e===null){this.removeAttribute(`template`);return}typeof e==`string`?this.setAttribute(`template`,e):e instanceof HTMLTemplateElement&&(Kg(this,Jg,e),Kg(this,Xg,null),this.createRenderer())}get props(){let e=[...Array.from(this.mediaController?.attributes??[]).filter(({name:e})=>t_[e]||e.startsWith(`breakpoint`)),...Array.from(this.attributes)],t={};for(let n of e){let e=t_[n.name]??Zo(n.name),{value:r}=n;r==null?t[e]=!1:($o(r)&&(r=parseFloat(r)),t[e]=r===``?!0:r)}return t}attributeChangedCallback(e,t,n){e===`template`&&t!=n&&qg(this,$g,e_).call(this)}connectedCallback(){qg(this,$g,e_).call(this)}createRenderer(){this.template instanceof HTMLTemplateElement&&this.template!==Wg(this,Yg)&&(Kg(this,Yg,this.template),this.renderer=new _g(this.template,this.props,this.constructor.processor),this.renderRoot.textContent=``,this.renderRoot.append(n_.content.cloneNode(!0),this.renderer))}render(){var e;(e=this.renderer)==null||e.update(this.props)}};Jg=new WeakMap,Yg=new WeakMap,Xg=new WeakMap,Zg=new WeakSet,Qg=function(e){if(Object.prototype.hasOwnProperty.call(this,e)){let t=this[e];delete this[e],this[e]=t}},$g=new WeakSet,e_=function(){let e=this.getAttribute(`template`);if(!e||e===Wg(this,Xg))return;let t=this.getRootNode(),n=(t?.getElementById)?.call(t,e);if(n){Kg(this,Xg,e),Kg(this,Jg,n),this.createRenderer();return}i_(e)&&(Kg(this,Xg,e),a_(e).then(e=>{let t=_s.createElement(`template`);t.innerHTML=e,Kg(this,Jg,t),this.createRenderer()}).catch(console.error))},r_.observedAttributes=[`template`],r_.processor=Fg;function i_(e){if(!/^(\/|\.\/|https?:\/\/)/.test(e))return!1;let t=/^https?:\/\//.test(e)?void 0:location.origin;try{new URL(e,t)}catch{return!1}return!0}async function a_(e){let t=await fetch(e);if(t.status!==200)throw Error(`Failed to load resource: the server responded with a status of ${t.status}`);return t.text()}N.customElements.get(`media-theme`)||N.customElements.define(`media-theme`,r_);function o_({anchor:e,floating:t,placement:n}){let{x:r,y:i}=l_(s_({anchor:e,floating:t}),n);return{x:r,y:i}}function s_({anchor:e,floating:t}){return{anchor:c_(e,t.offsetParent),floating:{x:0,y:0,width:t.offsetWidth,height:t.offsetHeight}}}function c_(e,t){let n=e.getBoundingClientRect(),r=t?.getBoundingClientRect()??{x:0,y:0};return{x:n.x-r.x,y:n.y-r.y,width:n.width,height:n.height}}function l_({anchor:e,floating:t},n){let r=d_(n)===`x`?`y`:`x`,i=r===`y`?`height`:`width`,a=u_(n),o=e.x+e.width/2-t.width/2,s=e.y+e.height/2-t.height/2,c=e[i]/2-t[i]/2,l;switch(a){case`top`:l={x:o,y:e.y-t.height};break;case`bottom`:l={x:o,y:e.y+e.height};break;case`right`:l={x:e.x+e.width,y:s};break;case`left`:l={x:e.x-t.width,y:s};break;default:l={x:e.x,y:e.y}}switch(n.split(`-`)[1]){case`start`:l[r]-=c;break;case`end`:l[r]+=c;break}return l}function u_(e){return e.split(`-`)[0]}function d_(e){return[`top`,`bottom`].includes(u_(e))?`y`:`x`}var f_=class extends Event{constructor({action:e=`auto`,relatedTarget:t,...n}){super(`invoke`,n),this.action=e,this.relatedTarget=t}},p_=class extends Event{constructor({newState:e,oldState:t,...n}){super(`toggle`,n),this.newState=e,this.oldState=t}},m_=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},q=(e,t,n)=>(m_(e,t,`read from private field`),n?n.call(e):t.get(e)),J=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},h_=(e,t,n,r)=>(m_(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Y=(e,t,n)=>(m_(e,t,`access private method`),n),g_,__,v_,y_,b_,x_,S_,C_,w_,T_,E_,D_,O_,k_,A_,j_,M_,N_,P_,F_,I_,L_,R_,z_,B_,V_,H_,U_,W_,G_,K_,q_,J_,Y_,X_,Z_,Q_,$_,ev,tv,nv,rv,iv,av,ov,sv;function cv({type:e,text:t,value:n,checked:r}){let i=_s.createElement(`media-chrome-menu-item`);i.type=e??``,i.part.add(`menu-item`),e&&i.part.add(e),i.value=n,i.checked=r;let a=_s.createElement(`span`);return a.textContent=t,i.append(a),i}function lv(e,t){let n=e.querySelector(`:scope > [slot="${t}"]`);if(n?.nodeName==`SLOT`&&(n=n.assignedElements({flatten:!0})[0]),n)return n=n.cloneNode(!0),n;let r=e.shadowRoot.querySelector(`[name="${t}"] > svg`);return r?r.cloneNode(!0):``}function uv(e){return`
  ...
  `}var Hv=class extends fv{get anchorElement(){return this.anchor===`auto`?ws(this).querySelector(`media-settings-menu-button`):super.anchorElement}};Hv.getTemplateHTML=Vv,N.customElements.get(`media-settings-menu`)||N.customElements.define(`media-settings-menu`,Hv);function Uv(e){return`
  ...
  `}function jy(){return M(`Captions`)}var My=e=>{e.setAttribute(`data-captions-enabled`,Kc(e).toString())},Ny=e=>{e.setAttribute(`aria-label`,M(`closed captions`))},Py=class extends Kv{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_SUBTITLES_LIST,j.MEDIA_SUBTITLES_SHOWING,j.MEDIA_LANG]}connectedCallback(){super.connectedCallback(),Ny(this),My(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_SUBTITLES_SHOWING?My(this):e===j.MEDIA_LANG&&Ny(this)}get invokeTargetElement(){return this.invokeTarget==null?ws(this)?.querySelector(`media-captions-menu`):super.invokeTargetElement}get mediaSubtitlesList(){return Fy(this,j.MEDIA_SUBTITLES_LIST)}set mediaSubtitlesList(e){Iy(this,j.MEDIA_SUBTITLES_LIST,e)}get mediaSubtitlesShowing(){return Fy(this,j.MEDIA_SUBTITLES_SHOWING)}set mediaSubtitlesShowing(e){Iy(this,j.MEDIA_SUBTITLES_SHOWING,e)}};Py.getSlotTemplateHTML=Ay,Py.getTooltipContentHTML=jy;var Fy=(e,t)=>{let n=e.getAttribute(t);return n?Rc(n):[]},Iy=(e,t,n)=>{if(!n?.length){e.removeAttribute(t);return}let r=Vc(n);e.getAttribute(t)!==r&&e.setAttribute(t,r)};N.customElements.get(`media-captions-menu-button`)||N.customElements.define(`media-captions-menu-button`,Py);var Ly=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Ry=(e,t,n)=>(Ly(e,t,`read from private field`),n?n.call(e):t.get(e)),zy=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},By=(e,t,n)=>(Ly(e,t,`access private method`),n),Vy,Hy,Uy,Wy,Gy,Ky={RATES:`rates`},qy=class extends fv{constructor(){super(),zy(this,Hy),zy(this,Wy),zy(this,Vy,new Fc(this,Ky.RATES,{defaultValue:Rp})),By(this,Hy,Uy).call(this)}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PLAYBACK_RATE,Ky.RATES]}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_PLAYBACK_RATE&&t!=n?(this.value=n,By(this,Hy,Uy).call(this)):e===Ky.RATES&&t!=n&&(Ry(this,Vy).value=n,By(this,Hy,Uy).call(this))}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,By(this,Wy,Gy))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`change`,By(this,Wy,Gy))}get anchorElement(){return this.anchor===`auto`?ws(this).querySelector(`media-playback-rate-menu-button`):super.anchorElement}get rates(){return Ry(this,Vy)}set rates(e){e?Array.isArray(e)?Ry(this,Vy).value=e.join(` `):typeof e==`string`&&(Ry(this,Vy).value=e):Ry(this,Vy).value=``,By(this,Hy,Uy).call(this)}get mediaPlaybackRate(){return P(this,j.MEDIA_PLAYBACK_RATE,1)}set mediaPlaybackRate(e){F(this,j.MEDIA_PLAYBACK_RATE,e)}};Vy=new WeakMap,Hy=new WeakSet,Uy=function(){this.defaultSlot.textContent=``;let e=this.mediaPlaybackRate,t=new Set(Array.from(Ry(this,Vy)).map(e=>Number(e)));e>0&&!t.has(e)&&t.add(e);let n=Array.from(t).sort((e,t)=>e-t);for(let t of n){let n=cv({type:`radio`,text:this.formatMenuItemText(`${t}x`,t),value:t.toString(),checked:e===t});n.prepend(lv(this,`checked-indicator`)),this.defaultSlot.append(n)}},Wy=new WeakSet,Gy=function(){if(!this.value)return;let e=new N.CustomEvent(k.MEDIA_PLAYBACK_RATE_REQUEST,{composed:!0,bubbles:!0,detail:this.value});this.dispatchEvent(e)},N.customElements.get(`media-playback-rate-menu`)||N.customElements.define(`media-playback-rate-menu`,qy);function Jy(e){return`
    <style>
      :host {
        min-width: 5ch;
        padding: var(--media-button-padding, var(--media-control-padding, 10px 5px));
