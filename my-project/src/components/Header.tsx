...
function Header() {
  ...
  return (
    <>
      <header className="sticky top-0 bg-white text-white w-full z-50">
        ...
        >
          <div className="flex items-center justify-between h-30">
            ...
            {/* Hamburger meny */}
            <div 
              className="ml-auto bg-[#985A1C] hover:bg-[#B87F45] m-2 space-y-1 rounded p-2 shadow md:hidden" 
          ...
          {isOpen && (
            <div className="absolute top-full left-0 w-screen z-40">
              <WidgetsDropdown />
            </div>
          )}
        </div>
